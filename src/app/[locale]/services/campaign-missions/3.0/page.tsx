...
import {
  TANKS_3_0 as TANKS,
  MISSION_TYPES_3_0 as MISSION_TYPES,
  MISSIONS_PER_TYPE,
...
const CAMPAIGN_ID = "3.0" as const;
...
export default function Campaign3Page() {
  const t = useTranslations("campaign30");
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm">{t("hero.extremeDifficulty")}</span>
                </div>
                <div className="flex items-center gap-2">
