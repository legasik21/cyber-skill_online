...
export default function Campaign2Page() {
  const t = useTranslations("campaign20");
  ...
  async function onSubmit(values: z.infer<typeof orderFormSchema>) {
    ...
    await submitOrder({
      ...
      service: 'campaign-missions-2.0',
      message: values.additionalInfo,
      page: 'Campaign Missions 2.0',
      orderDetails: {
          campaign: "2.0",
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm">{t("hero.hardDifficulty")}</span>
                </div>
                <div className="flex items-center gap-2">
                        ...
                        <CardContent className="pt-3 pb-3">
                          ...
                          <div className="mb-3 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
                            <div className="flex items-center gap-2">
                              ...
                              {tankMissionCount > 0 && (
                                <span className="bg-green-500/20 text-green-500 text-xs px-2 py-0.5 rounded">
                                  {t("calculator.selectedCount", { count: tankMissionCount })}
                                </span>
                              )}
                            </div>
                            ...
                            >
                              ...
                              {isFullTank
                                ? t("calculator.allSelectedTank")
                                : t("calculator.selectAllTank")}
                            </button>
                          </div>
                                    ...
                                    <tr key={type.id}>
                                      <td className="p-1 font-medium text-xs align-middle">
                                        <div className="flex flex-col gap-0.5">
                                          ...
                                          >
                                            {isFullType ? t("calculator.fullTypeDiscount") : t("calculator.selectAllType")}
                                          </button>
                                        </div>
                                      </td>
                                      {range1to15().map((num) => {
                              ...
                              return (
                                <div key={type.id} className="border border-border/50 rounded-lg p-3 bg-secondary/10">
                                  ...
                                  <div className="flex items-center justify-between mb-2">
                                    ...
                                    >
                                      {isFullType ? t("calculator.fullTypeDiscount") : t("calculator.selectAllTypeMobile")}
                                    </button>
                                  </div>
                  ...
                  <Card className="border-2 border-primary/20 bg-card h-full">
                    <CardHeader className="py-3 px-4">
                      <CardTitle className="text-base flex items-center justify-between">
                        <span>{t("selected.heading")}</span>
                        <span className="text-xs bg-primary/20 text-primary px-2 py-0.5 rounded">
                          {t("selected.selectedCount", { count: totalMissions })}
                        </span>
                      </CardTitle>
                    </CardHeader>
                      ...
                      <div className="space-y-1 text-sm">
                          ...
                          ([tankId, missionTypes]) => {
                            ...
                            return (
                              ...
                              >
                                ...
                                <div className="flex items-center gap-2">
                                  <span>{t("order.summaryTankMissions", { count: missionCount })}</span>
                                  {isFullTank && (
                                    <span className="text-green-500 font-bold text-[10px]">
                                      {t("order.summaryFullTankDiscount")}
                                    </span>
                                  )}
                                </div>
                              </div>
                        ...
                        <div className="border-t border-border pt-2 mt-2 space-y-1">
                          <div className="flex justify-between text-xs text-muted-foreground">
                            <span>{t("order.summaryBasePrice")}</span>
                            <span>${priceDetails.original}</span>
                          </div>
                          {priceDetails.discount > 0 && (
                            <div className="flex justify-between text-xs text-green-500">
                              <span>{t("order.summaryTotalDiscount")}</span>
                              <span>-${priceDetails.discount}</span>
                            </div>
                          )}
                          <div className="flex justify-between pt-1">
                            <span className="text-muted-foreground">
                              {t("order.summaryTotalPrice")}
                            </span>
